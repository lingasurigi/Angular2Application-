...
var UserHttpService = /** @class */ (function () {
    function UserHttpService(_http) {
        this._http = _http;
        this.baseUrl = 'http://localhost:1195/api/user/';
    }
    ...
    UserHttpService.prototype.extractData = function (res) {
        return res.json();
    };
    UserHttpService.prototype._errorHandler = function (error) {
        debugger;
        console.log(error);
...
//# sourceMappingURL=user.httpservice.js.map